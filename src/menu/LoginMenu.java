...
public class LoginMenu extends JFrame {
    ...
    private entity.Employee checkPassword(String phoneNumber, String password) {
        ...
        if(employee == null)
            JOptionPane.showMessageDialog(new JFrame(), "Wrong phone number or password", "Eror", JOptionPane.ERROR_MESSAGE);
        else if(BCrypt.checkpw(password,employee.getPassword())){
            return employee;
        }else{
            JOptionPane.showMessageDialog(new JFrame(), "Wrong phone number or password", "Error", JOptionPane.ERROR_MESSAGE);
        }
        return null;
    }
